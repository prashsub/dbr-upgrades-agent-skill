...
PATTERNS = [
    ...
    {
        "id": "BC-17.3-003",
        "name": "Spark Connect Literal Handling - Python (prefixed)",
        "severity": "LOW",
        "introduced_in": "17.3",
    ...
    {
        "id": "BC-17.3-003",
        "name": "Spark Connect Literal Handling - Python (bare array/struct)",
        "severity": "LOW",
        "introduced_in": "17.3",
    ...
    {
        "id": "BC-17.3-003",
        "name": "Spark Connect Literal Handling - Scala",
        "severity": "LOW",
        "introduced_in": "17.3",
