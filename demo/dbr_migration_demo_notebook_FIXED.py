...
# MAGIC | BC-16.4-007 | `MM/dd/yy` strict width | `coalesce(try_to_date M/d/yyyy, M/d/yy)` |
...
# ============================================================================
# FIX BC-16.4-007: Use coalesce(try_to_date) for mixed-format date data
# Three problems with the old approach:
#   1. to_date with MM/dd/yy throws on Serverless (ANSI mode)
#   2. coalesce(to_date(...)) also throws (first to_date errors before fallback)
#   3. M/d/y (single y) misinterprets 2-digit years as 0022
# Solution: coalesce(try_to_date M/d/yyyy, try_to_date M/d/yy)
#   - try_to_date returns NULL instead of throwing (Serverless-safe)
#   - M/d/yyyy catches 4-digit years; M/d/yy catches 2-digit years
#   - M and d handle variable-width months and days
# ============================================================================
...
# ✅ FIXED: coalesce with try_to_date handles all formats across all compute types
...
print("FIXED: DateTime pattern using coalesce(try_to_date M/d/yyyy, try_to_date M/d/yy)")
print("All dates parse correctly on standard clusters AND Serverless:")
...
# MAGIC | BC-17.3-002 | Implicit incremental listing | Explicit `.option()` | ✅ |
# MAGIC | BC-16.4-007 | `MM/dd/yy` strict width (JDK 17) | `coalesce(try_to_date M/d/yyyy, M/d/yy)` | ✅ |
